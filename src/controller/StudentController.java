...
// 우리는 데이터베이스가 없으므로
// 이 안에 ArrayList<>을 이용하여 유사 데이터베이스를 만들어보게 될 것이다.
...
public class StudentController {
    ...
    // 3. 파라미터로 넘어온 group과 같은 group에 속하는 StudentDTO 객체를
    ...
    // 6. 사용자가 요청한 id를 가진 StudentDTO 객체를 return해주는
    //    selectOne() 메소드
