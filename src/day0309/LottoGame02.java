...
public class LottoGame02 {
    ...
    public static void main(String[] args) {
        ...
        // 그대신, 배열의 각 칸에는 해당 엘리먼트에 대한 주소값이 저장되어 있다.
        // 따라서 우리가 해당 엘리먼트에 접근할 때에는(=값을 할당하거나 호출할 때에는)
        // 이름 대신 배열의 해당 칸에 저장되어 있는 주소값을 이용해서 접근하게 되는 것이다.
        // 그 떼, 우리가 배열의 몇번째 칸에 접근할 것인지를 적어야 하는데
        // 그 몇 번째 인지를 우리가 인덱스 라고 부르는 것이다.
        ...
        for (int i = 0; i < lottoNumbers.length; i++) {
            ...
            // 그 공간에 random.nextInt(NUMBER_NAX) + 1한 결과값을
            // 할당해라 라는 의미이다."
...
//        }
        ...
        while (idx < lottoNumbers.length) {
            ...
            // randomNumber가 우리의 int 배열인 lottoNumbers에 이미 존재하는 숫자일 때
            // 값이 false로 바뀔 boolean 변수 numberChecker
            boolean numberChecker = true;

            // 아래의 for 문은 우리가 lottoNumbers의 i 번째에 저장된 값과
