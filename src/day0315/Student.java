...
// 필요한 한가지 데이터타입으로 만들어주면 구조체 라는 특수한 데이터타입이 있었다.
// 예를 들어서 우리가 학생의 구조체를 만든다고 한다면
// 그 안에
// 번호, 이름, 국어 점수, 영어 점수, 수학 점수 를 넣어서
...
// 그리고 메인 메소드나 다른 메소드가 필요하다면 이 설꼐도로 객체를 직접 만들어서
// 쓰게 되는 것이다.
