...
public class Ex01Random {
    public static void main(String[] args) {
        ...
        // random 은 0이상 1 미만의 수많은 실수를 이용해서
        // 랜덤한 숫자를 제공해준다.
        
        // 1. 랜덤한 실수가 필요할 때에는 nextDouble()을 사용하면 된다.
        System.out.println(random.nextDouble());
        
        // 2. 랜덤한 int 범위의 숫자가 필요할 때에는 nextInt()를 사용하면 된다.
        System.out.println(random.nextInt());
        
        // 3. 만약 우리가 0부터 특정 숫자 미만의 랜덤한 숫자가 필요할 때에는
        //    nextInt(숫자) 를 넣으면
        //    0 부터 숫자-1까지의 랜덤한 숫자가 나온다!
        System.out.println(random.nextInt(10));
        
        // 만약 우리가 0~슷자-1이 아니라 1~숫자 까지의 랜덤한 숫자를 만들어 줄려면
        // random.nextInt(숫자) + 1 을 해서
        // 어떤 랜덤한 숫자가 나오던 간에 1씩 더해주는 방법을 사용해주면 된다.
