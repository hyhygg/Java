...
public class Ex01Printf {
    public static void main(String[] args) {
        ...
        // E. 16진법 정수를 오른쪽 정렬 5자리로 맞추고 왼쪽 빈자리는 0으로 채우고 알파벳이 있으면 대문자로 출력해라
        System.out.printf("E. [%05X]\n", number);

        // 3. 실수('f'loat)
        // 비록 float 의 f를 따왔지만 double이건 float이건 모두 사용 가능하다.
        System.out.println("3. 'f'loat");
        double d = 123.456;
        // A. 실수를 그대로 출력해라
        System.out.printf("A. [%f]\n", d);
        // B. 실수를 15자리 오른쪽 정렬해서 출력해라
        System.out.printf("B. [%15f]\n", d);
        // C. 실수를 15자리 왼쪽 정렬하고 소숫점은 2번째 자리까지만 출력해라 **뒷부분 반올림     
        System.out.printf("C. [%-15.2f]\n", d);
        // D. 실수를 15자리 오른쪽 정렬하고 소숫점은 2번째 자리, 왼쪽 빈자리는 0으로 채워서 출력해라      
        ...
        // C. 스트링을 오른쪽 정렬 10자리로 해서 내용은 바꾸지 말고 출력해라
        ...
        // 하지만 넘겨주는 것의 갯수가 %문자의 갯수보다 많으면 상관 없다.
        System.out.printf("첫번재 정수: %d 두번째 실수:%f \n", 2, 3.4, 5, 6, 7);
