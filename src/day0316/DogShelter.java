...
public class DogShelter {
    ...
    public static void main(String[] args) {
        ...
        Dog d1 = new Dog("강아지1", "01가0001", "말티즈", 5);
        list.add(d1);
        Dog d2 = new Dog("강아지2", "01나0021", "포메라니안", 4);
        list.add(d2);
        Dog d3 = new Dog("강아지3", "01다0033", "비글", 8);
        list.add(d3);

        while (true) {
            int userChoice = ScannerUtil.nextInt(scanner, "1. 잃어버린 개 등록 2. 일치하는 개 찾기 3. 주인 찾은개 목록에서 삭제 4. 종료");
            ...
            if (userChoice == 1) {
                ...
                while (list.contains(d)) {
                    System.out.println("해당 번호는 이미 등록된 등록 번호 입니다.");
                    d.setId(ScannerUtil.nextLine(scanner, message));
                }
                ...
                if (list.contains(d)) {
                    ...
                    // 2줄 합쳐서 list.get(list.indexOf(d)).printInfo(); 도 가능.
