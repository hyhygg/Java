...
// 그리고 해당 메소드가 어떻게 구현 될지는 그 인터페이스를 상속받는 클래스가
// 독자적으로 구현하게 된다.
...
// 3. Map
//    맵은 배열과는 다르게 순서가 존재하지 않고, 대신 우리가 Key 를 사용하여
...
public class Ex01ArrayList {
    public static void main(String[] args) {
        ...
        // 따라서, 여러분들이 숙제로 해올
        // 로또 게임의 ArrayList 버젼 같은 경우, 저 <>에 Integer 라고 적어주면 된다!
        ...
        // 이번 예제에서 사용할 Student 객체를 여러개 만들어보자
        ...
        // 4. 리스트의 특정 인덱스에 새로운 객체를 추가할 때에는
        ...
        // 7. 리스트 안에 특정 객체가 존재하는지 확인하고 싶을 때에는
        // contains(e) 메소드를 실행하면 된다.
        // 이 때에는 완전히 동일한 객체 뿐만이 아니라
        ...
        // contains(e) 와 마찬가지로, 원복 객체를 넣어줄 필요는 없지만
        ...
        // 9. 리스트 안에 특정 객체의 가장 마지막으로 등장하는 인덱스가 궁금할 때에는
        ...
        // 다른 객체이지만 equals(true)가 나오는 객체는 삭제가 된다.
