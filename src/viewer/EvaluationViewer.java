...
public class EvaluationViewer {
    ...
    private StudentViewer studentViewer; // 필드 studentViewer

    // EvaluationViewer : Student에 의존적 > 좋지 않음 > 의존성 주입.
    public EvaluationViewer(StudentViewer studentViewer) {
        ...
        // 파라미터studentViewer 아닌 필드 studentViewer 불러옴 -> this. 사용
    }
    ...
    public void printList(TeacherDTO t) {
        ...
        while (true) {
            ...
            for (EvaluationDTO e : list) {
                ...
                // studentController가 필요한데 그건 우리에게 없다.
            ...
            String message = new String("1. 새 평가 등록 2. 삭제 3. 뒤로 가기");
