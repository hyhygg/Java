...
public class LottoGame04Answer {
    ...
    public static void main(String[] args) {
        ...
        while (idx < lottoNumbers.length) {
            ...
            // 사용자가 입력한 숫자가 중복이 아니면 true이고, 중복이면 false가 저장되는 numberChercker
            ...
            // false이면, 이미 중복된 숫자입니다. 라는 메세지만 출력해 준다.
        ...
        // 우리가 lottoNumbers의 i 번째와 i + 번째를 비교해야하므로
        // 이 for문의 반복 조건식은 i가 lottoNumbers의 크기보다 1 작을 동안으로 해야
        // 4번재와 5번째를 비교하고 for문이 종료되서 혹시라도 존재하지 않는 6번째 인덱스에
        // 접근이 안되게 된다.
