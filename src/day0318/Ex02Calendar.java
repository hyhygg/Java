...
public class Ex02Calendar {
    public static void main(String[] args) {
        ...
        // "2021년 03월 18일 화요일 PM 03시 36분 30초"의 형태대로 출력이 된다.
        
        System.out.println(sdf.format(cal.getTime()));
        
        // Calendar 객체에 원하는 시간을 넣는 방법
        // 1. 1970년 01월 01일 0시 0분 부터 원하는 시간까지를 1/1000 소 단위로 구해서 직접 값을 넣는다. -> X
        // 2. 원하는 연월일 시분초에 직접 setter를 통해서 값을 넣어준다.
        //    단 연월일시분초를 각각 넣어주는것이 아니라
        //    (연, 월, 일) 혹은 (연, 월, 일, 시, 분, 초)를 묶어서 해주거나
        //    (저장한 필드, 값) 의 형태로 넣어주게 된다.     
        ...
        // 만약 우리가 값을 넣지 않을 필드에 현재 시간 기준의 값이 나오는 것을 원치 않으면
        // 먼저 현재 저장된 값들을 싹 비워주고
        // 그 다음에 값을 넣어주면 된다.
        // 저장된 값들을 비워줄 때에는 clear() 메소드를 호출해주면 된다.
        cal.clear();
        cal.set(Calendar.YEAR, 2002);
        System.out.println(sdf.format(cal.getTime())); // 1970년 01월 01일 목요일 오전 12시 00분 00초 : 기준점
        ...
        // 예시: 만약 우리가 형식을 yyyy.MM.dd 라고 정해놨는데
        //      사용자가 "으하하하하"를 바꿔달라고 요청한다면?
        // 그렇게 때문에 parse의 경우, 반드시 우리가 try/catch 라는 것을 사용해서
