    ...
    public static void main(String[] args) {
        ...
        for (int i = 1; i <= 2 * userNumber - 1; i++) {
            ...
            if (i < userNumber) {
                ...
                // 1번의 단점은, 코드가 매우 복잡해진다. 그리고 기존에 썼던 j for 문을 거의 새로 만드는 것과 똑같다.
                ...
                // 2번의 단점은 우리에게 허락된 메모리가 48kb이고 그리고 우리 메모리가 다 쓰게 되면 우주선이 터지기 때문에 변수를 마음껏 못만든다. -> 우린 이 세대가 아님.
            }
