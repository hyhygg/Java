...
// 각 출력 방법이 콘솔에 어떻게 나오는지 한번 알아보자

// 1. print()
//    print()는 괄호 안의 내용을 그대로 출력하고
//    만약 이후에 출력할 것이 있다면 출력된 내용이 오른쪽 칸부터 출력을 시작한다.
...
public class Ex09Print {
    public static void main(String[] args) {
        ...
        // println()은 ()의 출력이 끝나면 출력위치를 다음줄의 첫번재 칸으로 옮긴다.
