...
public class Ex07Operator03 {
    public static void main(String[] args) {
        ...
        // 그리고 나서 true 혹은 false가 10보다 작은지 체크할려고 하면 이해할 수 없는 코드가 되기 때문에 에러가 발생한다.
        // 따라서, 우리가 값이 범위에 속하는지를 체크하려고 한다면, 다음에 배우게 될 논리 연산자를 사용해야 한다!
        
        // 2. 변수와 변수가 아닌 값 자체를 비교할 때에는
        //    변수를 왼쪽에 두는 것이 좀더 가독성이 좋다.
        
        // 3. 참조형 변수의 값을 비교할 때에 비교 연산자를 사용하게 된다면 부정확한 결과값을 얻을 가능성이 매우 높다.
        
        // 참조형 변수가 필요하니까 String 객체 3개를 만들어보자
        ...
        // 그리고 우리가 String 객체를 비교하겠다라는건 그 글자들이 일치하는지를 비교하겠다 라는 의미가 된다.
